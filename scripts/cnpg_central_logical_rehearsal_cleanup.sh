...
echo "dropping source publication, residual slot, and temporary role"
...
echo "logical rehearsal cleanup completed: database=$rehearsal_database subscription=$subscription publication=$publication slot=$slot_name role=$replication_role"
