...
class VideoTranscriptResponse(ApiModel):
    videoId: str
    provider: str
    requestedLanguage: str
    resolvedLanguage: str | None = None
    languageName: str | None = None
    selectionReason: str | None = None
    transcriptType: str | None = None
    isAutoGenerated: bool | None = None
    isTranslated: bool | None = None
    state: Literal["available", "unavailable", "retryable_error", "failed"]
