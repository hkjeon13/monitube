"""Versioned Korean MeCab and English NLTK noun extraction."""
...
class AnalyzerUnavailableError(RuntimeError):
    """Raised instead of silently selecting a different analyzer."""


class MecabNltkNounAnalyzer:
    """Extract nouns with the existing deterministic analyzer semantics."""
...
def analyzer_health(analyzer: MecabNltkNounAnalyzer) -> dict[str, Any]:
    fixture = analyzer.extract("영상 분석 OpenAI market")
    if fixture != ["분석", "openai", "market"]:
